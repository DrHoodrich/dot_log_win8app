...
void ::dotLog::GroupedItemsPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::dotLog::GroupedItemsPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::dotLog::GroupedItemsPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&GroupedItemsPage::ItemView_ItemClick);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::Primitives::ButtonBase^>(target))->Click +=
            ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::dotLog::GroupedItemsPage::*)(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^))&GroupedItemsPage::Header_Click);
        break;
    }
